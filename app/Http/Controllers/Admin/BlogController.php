...
class BlogController extends JoshController
{
    ...
    public function store(BlogRequest $request)
    {
        ...
        if ($blog->id) {
        $this->send_notification($blog->id,$blog->title);
    ...
    public function send_notification($id,$title){



        define( 'API_ACCESS_KEY', 'AAAAwXL6CXg:APA91bEj7l9ap5zLRgiJtIC-oG4UI87At-4E4dOmnsLHcPLG525fRae-RhDwlhDhknKEheD9T7m_K5mzfLvrSNP6Jb5riomPNkOA7dT3U24zc3pDIo09pHs0SY8gHVgzNcE7HTzG0HLY');
        //   $registrationIds = ;
#prep the bundle
        $msg = array
        (
        ...
        (
            'ttl' => '86400s',
            'click_action'=>'org.beaconinvestment.action.BLOG_POST',
