                ...
                <div class="row">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <a href="{{ route('news.show',$item->id) }}">
                                        <img class="media-object" src="{{ URL::to('public/uploads/news/'.$item->image)  }}"
                                             alt="image">
                                    </a>
                                </div>
                    ...
                    <div class="col-sm-6 lifestyle">
                            <img class="img-responsive"
                                 src="{{ URL::to('public/uploads/news/'.$lifestyle->first()['image']) }}" alt="image">
                                        ...
                                        <div class="media-left">
                                            <a href="{{ route('news.show',$item->id) }}">
                                                <img class="media-object"
                                                     src="{{ URL::to('public/uploads/news/'.$item->image)  }}" alt="image">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                            <span class="text-danger">{!! date('d-m-Y', strtotime($item->created_at)) !!}</span>
                            ...
                            <div class="owl-carousel owl-theme" id="carousel">
                                @foreach($world_carousel as $item)
                                    <div class="item">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <img src="{{ URL::to('public/uploads/news/'.$item->image)  }}" alt="image">
                                            </div>
                                            <div class="col-sm-6">
                                                <span class="text-danger">{!! date('d-m-Y', strtotime($item->created_at)) !!}</span>
                                                <a href="{{ route('news.show', $item->id) }}">
                                    ...
                                    <div class="col-sm-6 news-body">
                                        <div class="media">
                                            <div class="media-left">
                                                <a href="{{ route('news.show',$item->id) }}">
                                                    <img class="media-object"
                                                         src="{{ URL::to('public/uploads/news/'.$item->image)  }}"
                                                         alt="image">
                                                </a>
                                            </div>
                                            <div class="media-body">
                        ...
                        <div class="col-sm-6 news-body mt-20">
                            ...
                            <a href="{{route('news.show', $business->first()['id'])  }}">
                                <img class="img-responsive height_180"
                                     src="{{ URL::to('public/uploads/news/'.$business->first()['image'])  }}" alt="image"/>
                            </a>
                            <div class="sports-height">
                                <a href="{{ route('news.show', $business->first()['id']) }}">
                    ...
                    @if($sports->count() !=0)
                        ...
                        <a href="{{ route('news.show',$sports->first()['id']) }}">
                            <img class="img-responsive height_180"
                                 src="{{ URL::to('public/uploads/news/'.$sports->first()['image'])  }}" alt="image">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="{{ route('news.show',$populars->id) }}">
                                                ...
                                                <img class="media-object" src="{{ URL::to('public/uploads/news/'.$populars->image)  }}"
                                                     alt="image">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="{{ route('news.show',$recentnew->id) }}">
                                            {{--<img class="media-object" src="{{ asset('assets/images/image_15.jpg') }}" alt="image">--}}
                                            <img class="media-object" src="{{ URL::to('public/uploads/news/'.$recentnew->image)  }}"
                                                 alt="image">
                                        </a>
                                    </div>
                                    <div class="media-body">
