                                                ...
                                                <!-- BEGIN FEATURED POST -->
                                                    <div class="featured-post-wide thumbnail">
                                                        @if($blog->image)
                                                            ...
                                                            <img src="{{ URL::to('public/uploads/blog/'.$blog->image)  }}" style="border-radius: 30%; max-width: 300px" class="img-responsive" alt="Image">
                                                        @endif
                                                        <div class="featured-text relative-left">
                                                            ...
                                                            <p class="text-right">
                                                                ...
                                                                <div class="fb-like" data-href="{{ URL::to('blogitem/'.$blog->slug) }}" data-layout="standard" data-action="like" data-size="large" data-show-faces="true" data-share="true"></div>
                                                            </p>
                                                        </div>
                                                        <!-- /.featured-text -->
                                                    </div>
