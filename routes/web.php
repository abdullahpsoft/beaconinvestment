...
Route::pattern('booking_code', '[a-z0-9- _]+');
...
Route::group(['middleware' => 'user'], function () {
    ...
    //Get Payment Schedule with Booking ID
//    Route::get('my-account/get_payments', 'FrontEndController@get_Ajax');
    //Get Payment Schedule with Booking Code
    Route::get('my-account/get_payments/{booking_code?}', 'FrontEndController@get_Ajax');
//    Route::get('blogitem/{slug?}', 'BlogController@getBlog');
//    Route::get('my-account/get_status', 'FrontEndController@get_Ajax');
});
...
Route::get('/csc', ['as' => 'csc', function () {
    return view('csc-tabs');
}]);

Route::get('/csc', ['as' => 'csc', function () {
    return view('csc-tabs');
}]);
Route::get('/eighteen', ['as' => 'eighteen', function () {
    return view('eighteen-tabs');
}]);

Route::get('/taj', ['as' => 'taj', function () {
    return view('taj');
}]);

Route::get('/parkview', ['as' => 'parkview', function () {
    return view('parkview');
}]);
Route::get('/park-price', ['as' => 'parkview', function () {
    return view('park-pricelist');
}]);
Route::get('/csc-price', ['as' => 'csc', function () {
    return view('csc-pricelist');
}]);

Route::get('/taj-price', ['as' => 'csc', function () {
    return view('taj-price');
}]);
...
Route::get('/palm', ['as' => 'palm', function () {
    return view('thepalm');
}]);


Route::get('/palm-price', ['as' => 'palm-price', function () {
    return view('thepalm-price');
}]);
Route::get('blognew','BlogController@index')->name('blognew');
